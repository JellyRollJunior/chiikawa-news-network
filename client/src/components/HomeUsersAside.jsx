...
const HomeUsersAside = () => {
  ...
  return (
    <aside className="main-container scrollbar-thin mx-4 mr-10 mt-3 mb-2 hidden w-xs flex-col gap-2 overflow-y-scroll px-3 pt-3.5 pb-2.5 md:flex">
      ...
      <ul className="flex flex-1 flex-col gap-2">
        {!isLoading
          ...
          : [...Array(5)].map((item, index) => (
              <Fragment key={index}>
                <HomeUserAsideListItem isLoading={true} />
              </Fragment>
            ))}
      </ul>
      <div className="duckegg-block h-4 shrink-0" />
